...
import {
  ...
  KNOCKOUT_SCORING_ROUNDS,
  teamsInMatchNumberRange,
} from "@/lib/bracket/knockout-rounds";
...
function computeAdvancementPoints(
  ...
  let total = 0;
  for (const round of KNOCKOUT_SCORING_ROUNDS) {
...
/**
 * Puntos por equipos que el usuario tenía en una ronda KO y que oficialmente están en esa ronda.
 */

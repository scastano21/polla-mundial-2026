...
export const config = {
  matcher: [
    // Excluir estáticos y archivos que rastrea Google (ads.txt, robots, sitemap).
    "/((?!_next/static|_next/image|favicon.ico|ads\\.txt|robots\\.txt|sitemap\\.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp|txt|ico)$).*)",
  ],
};

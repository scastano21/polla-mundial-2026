  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-zinc-700 bg-zinc-900 p-4">
      <p className="text-sm text-zinc-400">
        ...
        (incluye tercer puesto; <strong className="text-zinc-200">+6 a la final</strong>) suman cuando el cuadro de
        cada ronda queda definido. Sincroniza o usa recalcular tras cargar resultados.
      </p>
